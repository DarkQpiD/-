...
<tr>
<td align="center"><font size = "4"><strong>ลำดับ</strong></td>  
<td align="center"><font size = "4"><strong>ชื่อสินค้า</strong></td>
<td align="center"><font size = "4"><strong>จำนวน</strong></td>
</tr>
</div>
...
<?php 
  ...
  $sum=0;
  $sql = "SELECT pay_date,p_name,SUM(o_qty) as pTotal FROM order_detail
...
?>
<tr>
    <td><center><font style='font-size:18px'><? echo $i=$i+1; ?></td>
    <td><center><font style='font-size:18px'><? echo $rows['p_name']; ?></td>
    <td><center><font style='font-size:18px'><? echo $rows['pTotal']; ?></td>
</tr>
  <?php
    }
?>
