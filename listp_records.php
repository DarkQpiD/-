    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="listp_records.php" class="nav-item nav-link active">Products</a>
...
INNER join category
ON product.ct_id = category.ct_id
order by p_id";
$result=mysql_query($sql);

?>
<center>
<p><font size ="14px"><strong>ข้อมูลสินค้า</strong></font></p>
...
<td align="center"><font size = "4"><strong>ประเภทสินค้า</strong></td>
<td align="center"><font size = "4"><strong>สั่งสินค้า</strong></td>
<td align="center"><font size = "4"><strong>แก้ไขข้อมูล</strong></td>
</tr>
...
echo "<td><font style='font-size:18px'>".$rows['p_detail']."</td>";
echo "<td><center><font style='font-size:18px'>".number_format($rows["p_cost"])."</td>";
echo "<td><center><font style='font-size:18px'>".number_format($rows["p_price"])."</td>";
echo "<td><img src=' ".$rows['p_img']."'width='150'></td>";
echo "<td><center><font style='font-size:18px'>".$rows['p_num']."</td>";
echo "<td><center><font style='font-size:18px'>".$rows['ct_name']."</td>";
echo "<td align='center'><a href='ca.php?p_id=$rows[p_id]&act=add'><font style='font-size:18px'>เพิ่มลงตะกร้าสินค้า</a></td>";
echo "<td align='center'><a href='updatep.php?p_id=$rows[p_id]'><font style='font-size:18px'>update</a></td>";
echo "</tr>";
}
?>
...
<br>
<a href="insertp.php"><input type="button" name="add" value="เพิ่มข้อมูล"></a>
<a href="deletep.php"><input type="button" name="del" value="ลบข้อมูล"></a>
