...
<center>
<br>
<h3>รายงานข้อมูลรายละเอียดการส่งพัสดุ</h3><br>
...
<tr>
    <td align="center"><font size = "3"><strong>วันที่จัดส่งสินค้า</strong></td>              
    <td align="center"><font size = "3"><strong>หมายเลขพัสดุ</strong></td>
    <td align="center"><font size = "3"><strong>หมายเลขออเดอร์</strong></td>
    <td align="center"><font size = "3"><strong>ชื่อผู้รับ</strong></td>
    <td align="center"><font size = "3"><strong>ที่อยู่</strong></td>
    <td align="center"><font size = "3"><strong>เบอร์โทร</strong></td>
    <td align="center"><font size = "3"><strong>บริษัทขนส่ง</strong></td>
    <td align="center"><font size = "3"><strong>ค่าจัดส่ง</strong></td>
    <td align="center"><font size = "4"><strong>แก้ไขสถานะออเดอร์</strong></th>
    <td align="center"><font size = "3"><strong>แก้ไขข้อมูล</strong></td>

</tr>

<?php
    $search=isset($_GET['search']) ? $_GET['search']:'';
    $sql = "SELECT * FROM deliverly
        INNER JOIN payb
        ON deliverly.pay_id = payb.pay_id
        INNER JOIN order_head
        ON payb.o_id = order_head.o_id
        INNER JOIN user_dt
        ON order_head.username = user_dt.username
        INNER JOIN typed
        ON deliverly.t_id = typed.t_id
        WHERE order_head.s_id='DY' OR order_head.s_id='ND' AND (d_date LIKE '%$search%') 
        Order by d_date";
...
?>
<tr>
    <td><center><font style='font-size:14px'><?php echo date("d-m-Y",strtotime($rows['d_date']));?></td>
    <td><center><font style='font-size:14px'><?php echo $rows['d_id'];?></td>           
    <td><center><font style='font-size:14px'><?php echo $rows['o_id'];?></td>                      
    <td><center><font style='font-size:14px'><?php echo $rows['username'];?></td>                   
    <td><center><font style='font-size:14px'><?php echo $rows['ad'];?></td>
    <td><center><font style='font-size:14px'><?php echo $rows['tel'];?></td>
    <td><center><font style='font-size:14px'><?php echo $rows['t_name'];?></td>
    <td><center><font style='font-size:14px'><?php echo $rows['t_price'];?></td>
    <td align="center"><font style='font-size:18px'><a href='upstatu.php?o_id=<? echo $rows['o_id'] ?>'>แก้ไขสถานะ</a></td> 
    <td align='center'><a href='upd.php?d_id=<?php echo $rows['d_id']?>'><font style='font-size:18px'>แก้ไข</a></td>                                                                    
</tr>
<?php
    }
}else{
