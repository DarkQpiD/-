...
$o_id=$_GET['o_id'];
?>
<form name="form1" method="post" action="ind_ac.php" enctype="multipart/form-data">
<center><br>
<h3>รายละเอียดการชำระเงิน <?php echo $o_id; ?></h3><br>
<table>
<tr>
<td width="150">หมายเลขออเดอร์</td>
<td width="10">:</td>
<td width="301"><input name="o_id" type="hidden" id="o_id" value="<?php echo $o_id; ?>"><?php echo $o_id; ?></td>
</tr>
<tr>
    <td>วันที่ชำระเงิน</td>
    <td>:</td>
    <td><input name="pay_date" type="date" id="pay_date"></td>
</tr>
<tr>
    <td>เวลาที่ชำระเงิน</td>
    <td>:</td>
    <td><input name="pay_time" type="time" id="pay_time"></td>
</tr>
<tr>
    <td>หลักฐาน</td>
    <td>:</td>
    <td><input name="pay_img" type="file" id="pay_img" accept="image/png, image/gif, image/jpeg"></td>
</tr>
</table>
<br>
