...
<center>
    <br>
<h3>รายงานจำนวนสินค้าที่ต่ำกว่าหรือเท่ากับ 10</h3> 
<p> </p>
...
<td align="center"><font size = "4"><strong>จำนวนสินค้าที่เหลือ</strong></td>
</tr>
...
$i=0;
    $sql = "SELECT * FROM product 
        ...
        ?>
          <tr>
            <td><center><?php echo $i=$i+1;?></td>
            <td><center><?php echo $rows['p_id'];?></td>
            <td><center><?php echo $rows['p_name'];?></td>           
            <td><center><?php echo $rows['p_num'];?></td>                                           
          </tr>
<?php }?>
</table>
</center>
