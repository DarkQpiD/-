        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <div class="dropdown-menu m-0">
                        ...
                        <a href="report3.php" class="dropdown-item">รายงานการส่งพัสดุ</a>
                        <a href="report4.php" class="dropdown-item">รายงานสินค้าขายดีประจำเดือน</a>
                        <a href="report5.php" class="dropdown-item">รายงานข้อมูลการชำระเงิน</a>
...
<div align=center> 
<div class=name>
<h3>หมายเลขออเดอร์ <?php echo $o_id?></h3></div><br>
<p><center><font style='font-size:20px'>รายละเอียดสินค้าที่สั่ง</font></center></p>
<table width="70%" border="1" cellspacing="0" cellpadding="5">
<tr>
<td align="center"><font size = "4"><strong>รหัสสินค้า</strong></th>
<td align="center"><font size = "4"><strong>ชื่อสินค้า</strong></th>
<td align="center"><font size = "4"><strong>รายละเอียดสินค้า</strong></th>
<td align="center"><font size = "4"><strong>จำนวนสินค้า</strong></th>
<td align="center"><font size = "4"><strong>ราคา</strong></th>
</tr>
</center>
...
<tr>
    ...
    <td><center><font style='font-size:18px'><? echo $row['p_detail']; ?></td>
    <td><center><font style='font-size:18px'><? echo $row['o_qty'];?></td>
    <td><center><font style='font-size:18px'><? echo $row['o_sum'];}?></td>
</tr>
</table>
<p><center><a href="report1.php">กลับ</a>
<?php
$con->close();
?>
