...
if(!empty($_SESSION['cart']))
{
	...
	foreach($_SESSION['cart'] as $p_id=>$qty)
	{
		...
		//remove product
		echo "<td><center><font style='font-size:18px'><a href='ca.php?p_id=$p_id&act=remove'>ลบ</a></td>";
		echo "</tr>";
	}
	echo "<tr>";
    echo "<td>&nbsp;</td>";
...
<td colspan="6" align="right">
    ...
    <input type="button" name="Submit2" value="สั่งซื้อ" onclick="window.location='com.php';" />
</td>
</tr>
</table>
</form>
<br>
<a href="listp_records.php"><input type="button" name="del" value="กลับหน้ารายการสินค้า"></a>
</body>
</center>
