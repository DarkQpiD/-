    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="his.php" class="nav-item nav-link active">history</a>
...
<td align="center"><font size = "4"><strong>หมายเลขพัสดุ</strong></td>
</tr>
</div> 

<?php 
$username=$_SESSION["userID"];
$sql = "SELECT o_date,order_head.o_id,s_name,d_id, SUM(o_sum) as o_sum FROM order_detail
...
LEFT JOIN deliverly
ON payb.pay_id=deliverly.pay_id
WHERE username='$username' AND ((order_head.s_id='DY') OR (order_head.s_id='PY'))
...
<td align="center"><font style='font-size:18px'><?php echo $row['d_id']; ?></td>
</tr>
