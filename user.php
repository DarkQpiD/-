    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <p class="nav-item nav-link active"> <?php echo ($_SESSION['user']);?></p>  
...
<center><br>
<h3><strong>ข้อมูลส่วนตัว</strong></font></h3><br>
...
<td><font style='font-size:18px'><? echo $rows['username']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>Password:</strong></td>
<td><font style='font-size:18px'><? echo $rows['password']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>ชื่อ:</strong></td>
<td><font style='font-size:18px'><? echo $rows['name']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>นามสกุล:</strong></td>
<td><font style='font-size:18px'><? echo $rows['lastname']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>Email:</strong></td>
<td><font style='font-size:18px'><? echo $rows['email']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>ที่อยู่:</strong></td>
<td><font style='font-size:18px'><? echo $rows['ad']; ?></td>
</tr>
<tr>
<td align="center"><font size = "4"><strong>เบอร์โทร:</strong></td>
<td><font style='font-size:18px'><? echo $rows['tel']; ?></td>
</tr>
</table>
<br>
<p align="center"><a href="memupdate.php?username=<? echo $rows['username']; ?>">แก้ไขข้อมูล</a></p>
<?php
mysql_close();
?>
</center>
