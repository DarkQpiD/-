...
<center><br>
<h3>รายงานการแจ้งการชำระเงิน</h3><br>
...
<tr>
<td align="center"><font size = "4"><strong>วันที่ชำระเงิน</strong></td>
<td align="center"><font size = "4"><strong>เวลาที่ชำระเงิน</strong></td>
<td align="center"><font size = "4"><strong>หมายเลขออเดอร์</strong></td>
<td align="center"><font size = "4"><strong>ยอดเงินที่ชำระ</strong></td>
<td align="center"><font size = "4"><strong>หมายเลขชำระเงิน</strong></td>
<td align="center"><font size = "4"><strong>หลักฐาน</strong></td>
<td align="center"><font size = "4"><strong>สถานะ</strong></td>
<td align="center"><font size = "4"><strong>เปลี่ยนสถานะ</strong></td>
<td align="center"><font size = "4"><strong>เพิ่มการจัดส่ง</strong></td>
</tr>

<?php 
$search=isset($_GET['search']) ? $_GET['search']:'';
$sql = "SELECT pay_date,pay_time,order_head.o_id,pay_id,pay_img,s_name, SUM(o_sum) as o_sum FROM order_detail 
LEFT JOIN order_head
ON order_detail.o_id=order_head.o_id
LEFT JOIN payb
ON order_head.o_id=payb.o_id
LEFT JOIN sta
ON order_head.s_id=sta.s_id  
WHERE order_head.s_id = 'NP' OR (order_head.s_id = 'PY') OR (order_head.s_id = 'ND') AND (pay_date LIKE '%$search%')
Group By o_id
Order by o_id";
...
<tr>
<td align="center"><font style='font-size:18px'><?php echo date("d-m-Y",strtotime($row['pay_date'])); ?></td>
<td align="center"><font style='font-size:18px'><?php echo $row['pay_time']; ?></td>
<td align="center"><font style='font-size:18px'><?php echo $row['o_id'];?></td>
<td align="center"><font style='font-size:18px'><?php echo $row['o_sum']; ?></td>
<td align="center"><font style='font-size:18px'><?php echo $row['pay_id'];?></td>
<td align="center"><font style='font-size:18px'><?php echo "<img src=' ".$row['pay_img']." 'width='80'>";?></td>
<td align="center"><font style='font-size:18px'><?php echo $row['s_name'];?></td>
<td align="center"><font style='font-size:18px'><a href='upstatu.php?o_id=<? echo $row['o_id'] ?>'>แก้ไขสถานะ</a></td>
<td align="center"><font style='font-size:18px'><a href='insd.php?o_id=<? echo $row['o_id'] ?>'>เพิ่ม</a></td>
</tr>
