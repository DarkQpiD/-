...
?>
<center>
<br><h3><strong>แก้ไขข้อมูลสมาชิก</strong></font></h3><br>

<form name="form1" method="POST" action="memupdate_ac.php">
<label align="left">
<p><font size = "4"><strong>username:  </strong><input name="username" type="hidden" id="username" value="<? echo $rows['username']; ?>"><? echo $rows['username']; ?></p>
...
<p><font size = "4"><strong>email:  </strong><? echo $rows['email']; ?></p>
...
<br>
<a href="user.php"><input type="button" name="back" value="กลับ"></a>
