...
<center><br>
<h3>รายงานข้อมูลการสั่งซื้อสินค้า</h3></div><br>
...
<td align="center"><font size = "4"><strong>ชื่อสมาชิก</strong></th>
<td align="center"><font size = "4"><strong>ยอดเงินที่ต้องจ่าย</strong></th>
<td align="center"><font size = "4"><strong>สถานะออเดอร์</strong></th>
...
WHERE  order_head.s_id = 'NP' AND (o_date LIKE '%$search%' or username LIKE '%$search') 
...
?>
<tr>
<td align="center"><font style='font-size:18px'><?php echo date("d-m-Y",strtotime($row['o_date'])); ?></td>
