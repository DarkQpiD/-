...
?>
<center>
<br><h3><strong>แก้ไขรายละเอียดการส่งพัสดุหมายเลขออเดอร์ <? echo $rows['o_id']; ?></strong></h3><br>
<form name="form1" method="POST" action="upd_ac.php">
<label align="left">
<p><font size = "4"><strong>หมายเลขชำระเงิน: </strong><input name="pay_id" type="hidden" id="pay_id" value="<? echo $rows['pay_id']; ?>"><? echo $rows['pay_id']; ?></p>
<p><font size = "4"><strong>หมายเลขพัสดุ: </strong><input name="d_id" type="text" id="d_id" value="<? echo $rows['d_id']; ?>"></p>
<p><font size = "4"><strong>วันที่ส่งพัสดุ: </strong><input name="d_date" type="date" id="d_date" value="<? echo $rows['d_date']; ?>"></p>
<p><font size = "4"><strong>บริษัทขนส่ง: </strong>
<select name=t_id>
			<option value="scg">SCG Express</option>
			<option value="it">Inter Express Chilled & Frozen</option>
			<option value="jwd">JWD Express</option>
		</select>
</label>
<br>
<center>
    <a href='report5.php'><input type="button" name="back" value="กลับ">
