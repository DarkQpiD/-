...
<tr>
<td align="center" colspan="9"><font size = "5"><strong>ข้อมูลสินค้าที่ต้องการลบ</strong> </td>
</tr>
...
<td align="center"><font size = "4"><strong>ลบข้อมูล</strong></td>
</tr>
</center>
...
<tr>
<td align="center"><font style='font-size:18px'><? echo $rows['p_id']; ?></td>
<td align="center"><font style='font-size:18px'><? echo $rows['p_name']; ?></td>
<td align="center"><font style='font-size:18px'><? echo $rows['p_detail']; ?></td>
<td align="center"><font style='font-size:18px'><? echo $rows['p_price']; ?></td>
<td align="center"><font style='font-size:18px'><? echo $rows['p_img']; ?></td>
<td align="center"><font style='font-size:18px'><? echo $rows['p_num']; ?></td>
<td align="center" bgcolor="#FFFFFF"><a href="deletep_ac.php?p_id=<? echo $rows['p_id']; ?>">delete</a></td>
</tr>
...
<br>
<center><a href="listp_records.php"><input type="button" name="record" value="กลับหน้าหลัก"></a></center>
