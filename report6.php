...
<center><br>
<h3>รายงานข้อมูลสินค้าตามประเภท</h3><br>

<form action=" " method="post">
                <select name="ct_id">
                  <option value="c">เลือกประเภท</option>
                  <option value="c1">ไอติมถ้วย</option>
                  <option value="c2">ไอติมถัง</option>
              </select>
...
<?php
          ...
          $i=0;
            $sql = "SELECT * FROM product
                    ...
                    WHERE product.ct_id LIKE '%$home%'";
            $rows = mysql_query($sql);
            while($row = mysql_fetch_assoc($rows)){
        ?>
          <tr>
            <td><center><?php echo $row['p_id'];?></td>
            <td><center><?php echo $row['ct_name'];?></td>           
            <td><center><?php echo $row['p_name'];?></td>                    
            <td><center><?php echo $row['p_detail'];?></td>                      
            <td><center><?php echo "<img src=' ".$row['p_img']." 'width='80'>";?></td>                                                                
          </tr>
