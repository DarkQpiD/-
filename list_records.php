...
<center>
<p><font size ="14px"><strong>ข้อมูลสมาชิก</strong></font></p>
...
<td align="center"><font size = "4"><strong>Update</strong></td>
</tr>
...
<td align="center"><a href="update.php?username=<? echo $rows['username']; ?>">update</a></td>
</tr>
...
<br>
<a href="insert.php"><input type="button" name="add" value="เพิ่มข้อมูล"></a>
<a href="delete.php"><input type="button" name="del" value="ลบข้อมูล"></a>
<?php
mysql_close();
?>
</center>
