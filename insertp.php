...
<form name="form1" method="post" action="insertp_ac.php" enctype="multipart/form-data">
<center>
<h3>ข้อมูลสินค้า</h3><br>
<table>
<tr>
<td width="150">รหัสสินค้า</td>
<td width="10">:</td>
<td width="301"><input name="p_id" type="text" id="p_id"></td>
</tr>
<tr>
    <td>ชื่อสินค้า</td>
    <td>:</td>
...
<tr>
    ...
    <td>:</td>
    <td><input name="p_detail" type="text" id="p_detail"></td>
</tr>
<tr>
    <td>ราคาต้นทุน</td>
    <td>:</td>
    <td><input name="p_cost" type="text" id="p_cost"></td>
</tr>
<tr>
    <td>ราคาสินค้า</td>
    <td>:</td>
...
<tr>
    <td>รูปสินค้า</td>
    <td>:</td>
    <td><input name="p_img" type="file" id="p_img" accept="image/png, image/gif, image/jpeg"></td>
</tr>
<tr>
    <td>จำนวนสินค้า</td>
    <td>:</td>
    <td><input name="p_num" type="text" id="p_num"></td>
</tr> 
<tr>
    <td>ประเภทสินค้า</td>
    <td>:</td>
    <td><input name="ct_id" type="text" id="ct_id"></td>
</tr>   
</table>
<br>
